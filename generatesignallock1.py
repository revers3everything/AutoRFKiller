...
class generatesignallock1(gr.top_block, Qt.QWidget):

    def __init__(self,vector_bits,freq):
        ...
        self.settings = Qt.QSettings("GNU Radio", "generatesignallock1")
        ...
        self.blocks_vector_source_x_1 = blocks.vector_source_c((vector_bits), True, 1, [])
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, 600)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq, 4, 0, 0)
...
def main(top_block_cls=generatesignallock1, options=None):
    ...
    tb = top_block_cls(vector_bits,freq)
